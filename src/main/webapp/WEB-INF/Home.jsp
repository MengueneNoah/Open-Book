...
=======
    <<<<<<< HEAD <div style="padding-top: 60px; padding-bottom: 30px; background-color: #f3f2f2;"
        ...
        <h1 class="text-center text-dark fw-bold fs-3 mb-4">
            La bibliothèque OpenBook est l'endroit <span class="text-primary">fournisseur digital</span> <br /> idéal
            pour tous les amoureux de la lecture
        </h1>
>>>>>>> afe7fe70395e081c5f19c2ee0978642e8d7fbbda
        <p class="text-center text-black mb-4">Notre équipe de bibliothécaires passionnés est à votre disposition pour
            ...
            un
            bon livre, la bibliothèque X est l'endroit parfait pour vous. Nous sommes impatients de vous accueillir et
            de vous
...
>>>>>>> afe7fe70395e081c5f19c2ee0978642e8d7fbbda
        ...
        <div style="margin-top: 60px; margin-bottom: 30px"
            ...
            <p class="text-center text-black mb-4">Notre équipe de bibliothécaires passionnés est à votre disposition
                pour
                vous
                aider à trouver les documents qui vous intéressent et vous conseiller sur les nouveautés littéraires à
                ne
                pas
                manquer. Nous organisons également régulièrement des événements tels que des clubs de lecture, des
                conférences et
                des séances de dédicaces pour offrir à nos lecteurs une expérience encore plus enrichissante.<br />
                Que vous soyez un lecteur assidu ou que vous cherchiez simplement à passer un moment agréable en
                feuilletant
                un
                bon livre, la bibliothèque OpenBook est l'endroit parfait pour vous. Nous sommes impatients de vous
                accueillir et
                de vous
                aider à découvrir votre prochaine lecture préférée.</p>
            <a href='#' class="btn btn-primary fw-bold py-3 px-5 rounded">Besoin d'un service</a>
                ...
                <form action="container">
                    <div class="my-3">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control pb-5" style="background: blue!important;" id="type"
                                    name="type">
                                    <option value="">Sélectionnez un type de document</option>
                                    <c:forEach var="documentType" items="${types}">
                                        <option value="${ documentType.getId() }">${ documentType.getLibelle() }
                                        </option>
                                    </c:forEach>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" id="publishing_house" name="publishing_house">
                                    ...
                                    <c:forEach var="publishingHouse" items="${publishingHouses}">
                                        <option value="${ publishingHouse.getId() }">${ publishingHouse.getName() }
                                        </option>
                                    </c:forEach>
                                </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3">
                                                            <select class="form-control" id="title" name="title">
                                                                <option value="">Title</option>
                                                                <c:forEach var="doc" items="${documents}">
                                                                    <option value="${ doc.getId() }">${ doc.getTitle() }
                                                                    </option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <select class="form-control" id="type" name="type">
                                                                <option value="">Sélectionnez un type de document
                                                                </option>
                                                                <c:forEach var="documentType" items="${types}">
                                                                    <option value="${ documentType.getId() }">${
                                                                        documentType.getLibelle() }</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>

                                                        <div class="col-sm-3">
                                                            <select class="form-control" id="publishing_house"
                                                                name="publishing_house">
                                                                <option value="">Sélectionnez une maison d'édition
                                                                </option>
                                                                <c:forEach var="publishingHouse"
                                                                    items="${publishingHouses}">
                                                                    <option value="${ publishingHouse.getId() }">${
                                                                        publishingHouse.getName() }</option>
                                                                </c:forEach>
                                                            </select>
                                                    ...
                                                    <c:forEach items="${documents}" var="document" varStatus="loop">
                                                        ...
                                                        <div class="col">
                                                            <div class="card h-100">
                                                                <img src="${document.getImageUrl()}"
                                                                    class="card-img-top" alt="${document.getTitle()}" />
                                                                <div class="card-body">
                                                                    <h5 class="card-title" style="font-weight: bold;">
                                                                        ${document.getTitle()}</h5>
                                                                    <c:set var="summary">${document.getSummary()}
                                                                    </c:set>
                                                                    <c:set var="summaryWithoutFirstSentence"
                                                                        value="${fn:substringAfter(summary, '... ')}" />
                                                                    <p style="text-align: justify;" class="card-text">
                                                                        ${fn:substringBefore(summary,
                                                                        '.')}.
                                                                        <span
                                                                            class="more-text d-none">${summaryWithoutFirstSentence}</span>
                                                                    </p>
                                                                </div>
                                                                <div
                                                                    style="text-align: center; margin: 1%; width: 100%; font-weight: bold;">
                                                                    <table class="table table-striped">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>${document.getPublishingHouse().getName()}
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Publier le </td>
                                                                ...
                                                                <div
                                                                    style="margin-left: 2%; margin-bottom: 2%; width: 100%;">
                                                                    <!-- Button trigger modal-->
                                                                    <button type="button" class="btn btn-info"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#myModal${loop.index}">Lire la
                                                                        suite</button>

                                                                    <a style="margin-left: 30%;" class="btn btn-success"
                                                                        href="/OpenBook/DetailsServlets?bookId=${ document.getId() }">Plus
                                                                        de details</a>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-header">
                                                                                    <h4 class="modal-title">
                                                                                        <i
                                                                                            class="bi bi-quote">${document.getTitle()}</i>
                                                                                    </h4>
                                                                                    <button type="button"
                                                                                        class="btn-close"
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <p
                                                                                        style="text-align: text-justify;">
                                                                                        ${document.getSummary()}</p>
                                                                                </div>
            ...
            <div class="container py-5">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-10 col-xl-8 text-center">
                        ...
                        <p class="mb-4 pb-2 mb-md-5 pb-md-0">Découvrez ce que nos clients disent de notre librairie.
                            Nous
                            sommes fiers
                            ...
                            <div class="card">
                                <div class="card-body py-4 mt-2">
                                    <div class="d-flex justify-content-center mb-4">
                                        <img src="${testimonial.picture}" class="rounded-circle shadow-1-strong"
