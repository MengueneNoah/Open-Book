        ...
        <div class="container">
            <div class="row">
                ...
                <div
                    ...
                    <h1>Ã€ propos de Open Book</h1>
                    <h4 class="mb-3">DÃ©couvrez notre librairie numÃ©rique</h4>
                    <p class="mt-2" style="text-align: justify;">Open Book est une librairie numÃ©rique proposant une
                        large sÃ©lection de
                        livres Ã©lectroniques de qualitÃ©. Nous mettons Ã  disposition des lecteurs des ouvrages de
                        diffÃ©rents genres, allant de la fiction Ã  la non-fiction, en passant par les ouvrages de
                        rÃ©fÃ©rence. GrÃ¢ce Ã  notre plateforme, vous pouvez dÃ©couvrir et lire des livres depuis votre
                        ordinateur, tablette ou tÃ©lÃ©phone portable, oÃ¹ que vous soyez dans le monde.</p>

                    <div class="icon-box">
                        <div class="d-flex align-items-center">
                            <div class="icon me-2"><i class="bi bi-patch-check-fill"></i></div>
                            <h4 class="title"><a class="text-dark" href="#">QualitÃ© garantie</a></h4>
                        </div>
                        <p class="description">Tous les livres proposÃ©s sur Open Book sont soigneusement
                            sÃ©lectionnÃ©s pour leur qualitÃ© et leur pertinence, afin de garantir une expÃ©rience de
                            lecture agrÃ©able pour nos utilisateurs.</p>
                    </div>

                    <div class="icon-box" data-aos-delay="100">
                        <div class="d-flex align-items-center">
                            <div class="icon me-2"><i class="bi bi-star-fill"></i></div>
                            <h4 class="title"><a class="text-dark" href="#">Offres spÃ©ciales</a></h4>
                        </div>
                        <p class="description">Nous proposons rÃ©guliÃ¨rement des offres spÃ©ciales sur certains
                            livres, ainsi que des rÃ©ductions pour les utilisateurs rÃ©guliers. Inscrivez-vous Ã  notre
                            newsletter pour Ãªtre tenu informÃ© de nos promotions en cours.</p>
                    </div>
                    ...
                    <div class="icon-box">
                        ...
                        <p class="description">Notre plateforme a Ã©tÃ© conÃ§ue pour offrir une expÃ©rience utilisateur
                            simple et intuitive. Trouvez facilement les livres que vous recherchez grÃ¢ce Ã  notre
                            fonction de recherche avancÃ©e, et gÃ©rez votre bibliothÃ¨que numÃ©rique depuis votre compte
                            utilisateur.</p>
                    </div>
...
<<<<<<< HEAD
    </section><!-- Fin de la section Ã€ propos -->
=======
